	...
	return CrawlResult{
		...
		Packages: []crawlers.CrawledPackage{
			...
			},
			{
				...
				Duration:       9,
				Airline:        "IndiGo",
				HotelMakkah:    "Hotel Bintang 3 (shuttle bus)",
			...
			},
			{
				...
				Duration:       9,
				Airline:        "Saudia Airlines",
				HotelMakkah:    "Hotel Bintang 5 (shuttle bus)",
				HotelMadinah:   "Hotel Bintang 3",
			...
			},
			{
				...
				Duration:       9,
				Airline:        "Saudia Airlines",
				HotelMakkah:    "Hotel Bintang 5",
				HotelMadinah:   "Hotel Bintang 5",
			...
			},
			{
				...
				Duration:       9,
				Airline:        "Saudia Airlines",
				HotelMakkah:    "Hotel Bintang 5 Depan Masjidil Haram",
				HotelMadinah:   "Hotel Bintang 5",
				DepartureDates: []string{"22 Okt 2026"},
				Seats:          30,
				Airport:        "Jakarta",
