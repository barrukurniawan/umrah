	...
	return CrawlResult{
		...
		Packages: []crawlers.CrawledPackage{
			...
			},
			{
				...
				PackageName:    "Umrah Fandiego 9 Hari Hemat (UAS)",
				Price:          33900000,
				Duration:       9,
				Airline:        "Saudia",
			...
			{
				TravelName:     "PT Wisata Hati Universal",
				PackageName:    "Umrah Fandiego 9 Hari Reguler (UAS)",
				Price:          36900000,
				Duration:       9,
				Airline:        "Saudia",
			...
			{
				TravelName:     "PT Wisata Hati Universal",
				PackageName:    "Umrah Fandiego 9 Hari Gold (UAS)",
				Price:          40900000,
				Duration:       9,
				Airline:        "Saudia",
			...
			{
				TravelName:     "PT Wisata Hati Universal",
				PackageName:    "Umrah Fandiego 9 Hari Diamond (UAS)",
				Price:          46900000,
				Duration:       9,
				Airline:        "Saudia",
			...
			{
				TravelName:     "PT Wisata Hati Universal",
				PackageName:    "Umrah Fandiego 11 Hari Hemat (UAS)",
				Price:          35900000,
				Duration:       11,
				Airline:        "Saudia",
				HotelMakkah:    "Le Meridien Tower",
			...
			{
				TravelName:     "PT Wisata Hati Universal",
				PackageName:    "Umrah Fandiego 11 Hari Reguler (UAS)",
				Price:          38900000,
				Duration:       11,
				Airline:        "Saudia",
				HotelMakkah:    "Grand Al Massa",
			...
			{
				TravelName:     "PT Wisata Hati Universal",
				PackageName:    "Umrah Fandiego 11 Hari Gold (UAS)",
				Price:          43900000,
				Duration:       11,
				Airline:        "Saudia",
				HotelMakkah:    "Prestige Hotel",
			...
			{
				TravelName:     "PT Wisata Hati Universal",
				PackageName:    "Umrah Fandiego 11 Hari Diamond (UAS)",
				Price:          50900000,
				Duration:       11,
				Airline:        "Saudia",
				HotelMakkah:    "Pullman Hotel",
